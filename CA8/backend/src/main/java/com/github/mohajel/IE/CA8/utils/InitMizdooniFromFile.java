...
import static com.github.mohajel.IE.CA8.utils.Utils.logAppendFile;
...
public class InitMizdooniFromFile {
    public static String input_file = "/src/main/java/com/github/mohajel/IE/CA8/utils/inputForInit.txt";
